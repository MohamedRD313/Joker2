...
async def _(event):
    await event.edit(" **اوامر المتـحركات 🦂**\n\n ✎┊‌ اختر احداها\n\n**- { `.متحركات كيوت` } **\n**- { `.متحركات ساد` }**\n\n**العقرب |  𝗦𝗰𝗼𝗿𝗽𝗶𝗼 🦂**"
            )
...
async def _(event):
    await event.edit(" اوامر متحـرات سـاد 🦂\n\n ✎┊‌ اختر احداها\n\n**- { `.س1` } **\n**- { `.س2` } ** \n**- {`.س3`}**\n**- { `.س4`}** \n**- { `.س5` } **\n**- { `.س6` }**\n**- { `.س7` }**\n**- { `.س8` }**\n**- { `.س9` }**\n\n**العقرب |  𝗦𝗰𝗼𝗿𝗽𝗶𝗼 🦂**"
            )
...
async def _(event):
    await event.edit(" اوامر متحـرات كيـوت :\n\n ✎┊‌ اختر احداها\n\n**- { `.ك1` } \n**- { `.ك2` }**   \n**- {`.ك3`}*\n**- { `.ك4`}** \n**- { `.ك5` }** \n**- { `.ك6` }**\n**- { `.ك7` }**\n\n**العقرب |  𝗦𝗰𝗼𝗿𝗽𝗶𝗼 🦂**"
            )           
