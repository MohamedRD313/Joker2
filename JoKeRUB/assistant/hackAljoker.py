...
'''
mm = '''
قم بالاستفسار الى قناة العقرب https://t.me/Scorpions_scorp
'''
...
keyboard = [
  ...
  [
    Button.url("سورس العقرب 🦂", "https://t.me/Scorpions_scorp")
    ]
]
if Config.TG_BOT_USERNAME is not None and tgbot is not None:
    ...
    async def inline_handler(event):
        ...
        if query.startswith("هاك") and event.query.user_id == bot.uid:
            buttons = Button.url(" اضغط هنا عزيزي ", f"https://t.me/Scorpions_scorp")
  ...
  if event.sender_id == bot.uid:
      async with bot.conversation(event.chat_id) as x:
        keyboard = [
          ...
          [
            Button.url("المطور", "https://t.me/Scorpions_scorp")
            ]
        ]
